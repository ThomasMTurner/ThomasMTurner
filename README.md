...
My name is Thomas Turner, and I am a second year Computer Science student at the University of Bath. In my first year, I built various technically involved personal projects, requiring a lot of independent research, e.g. a search engine and full-stack portfolio web application. I have gained experience in Computer Vision and Machine Learning in the Futures sector of Roke Manor Research, working on synthetic data generation and object detection. Currently, I am an intern in ARM's Developer Advocacy division, developing Artificial Intelligence featured applications and optimising neural networks for ARM-based hardware, and voluntarily contribute as a Technical Lead in full-stack development for EDEN (Employment Devices Enhancing Neurodiversity). Furthermore, I write articles in various topics concerning technology, neuroscience, philosophy and the works of Emmanuel Swedenborg. My profile is (https://substack.com/@mycer?utm_source=user-menu), my three primary periodicals are there.
